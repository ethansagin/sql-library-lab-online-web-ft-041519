...
def select_series_title_with_most_human_characters
  "SELECT Series.title, Characters.species FROM series JOIN Characters ON Series.id = Characters.series_id WHERE Characters.species = 'human' GROUP BY Series.title;"
end
