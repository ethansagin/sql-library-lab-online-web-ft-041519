...
def select_series_title_with_most_human_characters
  "SELECT Series.title, Characters.species, COUNT(Characters.species) FROM series WHERE Character.species = 'human' JOIN Characters ON Series.id = Characters.series_id"
end
