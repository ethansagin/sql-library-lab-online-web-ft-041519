...
def select_series_title_with_most_human_characters
  "SELECT Series.title, Characters.species, COUNT(Characters.species) AS Char_count FROM series LEFT JOIN Characters ON Series.id = Characters.series_id GROUP BY Characters.species;"
end
